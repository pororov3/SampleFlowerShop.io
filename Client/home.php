...
<body onLoad="homeOnLoad();headLoad();">
	...
	<div class="product-section">
		<div class="header">
			Welcome to Beth's <br>
			<button>Shop Now</button>
		</div>

		<div class="row" id="insertitems">
			<!--item1-->
			<!--<div class="col-sm-3 add-to-cart" id="1">
				<div class="product-background-color">
						<div class="product-image">
							<div class="promo">
								<label></label>
							</div>
							<img src="image/sampaguita.jpg">
						</div>
						<div class="product-name">
							Sampaguita
						</div>
						<div class="product-price">
							<label><span>&#8369;</span>100.00</label>
						</div>
						<div class="product-add">
							<button onclick="window.location.href='add-to-cart.php'">Add to Cart</button>
					</div>
				</div>	
			</div>-->
			<!--end item1-->
...
<script type="text/javascript">
	...
	$( document ).on( "click", "button", function ( evt ) {
		evt.preventDefault();
		//alert( $( this ).attr( "id" ) );
		localStorage.setItem( 'selitemID', $( this ).attr( "id" ) );
	} ); // for button click
	...
	/*var buttons = document.getElementsByClassName( "homeproducts" );
	var buttonsCount = buttons.length;
	for ( var i = 0; i <= buttonsCount; i += 1 ) {
		buttons[ i ].onclick = function ( e ) {
			//var orderNo = $( 'button[class=homeproducts]:click' ).attr( 'id' );
			//localStorage.setItem( 'btnid', this.id );
			alert(this.value);
		};
	}*/
</script>
