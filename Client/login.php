...
<body onLoad="ifLoggedIn();headLoad();loaduserInfo();">
...
<div class="product-section">
	<div class="log-in">
		<div class="log-in-form">
			<label>Be part of us</label>
			<p>Log in your account here!</p>
			<i class="fa fa-user-circle" aria-hidden="true" style="font-size: 50px;color: yellow"></i><br>
			<i class="fa fa-user icon-form" style="font-size: 15px;"></i><input type="" name="" placeholder="Username" id="cllUsername"><br>
			<i class="fa fa-key icon-form" style="font-size: 10px;"></i><input name="" type="password" placeholder="Password" id="cllPassword"><br>
			<input type="checkbox" onclick="myFunction()" style="width: 15px;" id="cllPassword">Show Password<br>
			<button onClick="loaduserInfo();cllLoginBtn();" id="clLoginBtn">Login</button><br>
			or<br><br>
...
//showpassword
		function myFunction() {
		  var x = document.getElementById("cllPassword");
		  if (x.type === "password") {
		    x.type = "text";
		  } else {
		    x.type = "password";
