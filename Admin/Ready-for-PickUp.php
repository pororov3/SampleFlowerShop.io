			...
			<div class="row">
				<div class="col-12 order-reserve-padding">
					<div class="order-reserve">
						...
						<div class="alert alert-success" id="pickup" style="display: none;" role="alert">
							Items Succesfully Pickup!
						</div>
						<div class="filter-by">
							<input type="" name="" placeholder="Search..." id="rpSearch">
							<button id="rpSearchBtn" onClick="rpSearchBtn()">Search</button>
						</div>
						<table class="table table-bordered">
							...
							<tbody id="insertReadyforPickup">
								<!--<tr>
						       	...
						       	<td></td>
						       	<td>
						       		<button onclick="showpickup()" >Pickup</button>
						       	</td>
						      </tr>-->
							</tbody>
						</table>
	...
	function getuser() {
		$.ajax( {
			...
			success: function ( data ) {
				document.getElementById( "rplabel" ).innerHTML = data;
			},
			error: function () {
