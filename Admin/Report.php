...
<html>
<head>
	<title>Ordering and Reservation Report</title>
	<meta charset="utf-8">
	...
	<script src="functions/report.js"></script>
</head>
...
<body>
	...
	<div class="side">
		...
		<button class="collapsibles" style="background-color: #ff0066">Report <img src="image/down.png"></button>
		<div class="content">
			...
			<div class="row">
				<div class="col-12 order-reserve-padding">
					<div class="order-reserve">
						<h4>Ordering and Reservation Report</h4>
						<div class="row">
							<div class="col-2">
								<label>From</label>
							...
							<div class="col-2">
								...
								<br>
								<select id="typeOfOrder" class="type-generate" style="width: 100%;padding: 7px;font-size:14px;border-radius: 4px;border-color: grey;outline: none;">
									<option>All</option>
							...
							<div class="col-2">
								...
								<br>
								<button class="generate-button" onclick="reportTORSearchBtn();">Generate
