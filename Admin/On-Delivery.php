			...
			<div class="row">
				<div class="col-12 order-reserve-padding">
					<div class="order-reserve">
						<h4>On Delivery</h4>
						<div class="filter-by">
							<input type="" name="" placeholder="Search..." id="odSearch">
							<button id="odSearchBtn" onClick="odSearchBtn()">Search</button>
						</div>
						<table class="table table-bordered">
							...
							<tbody id="insertOnDelivery">
								<!--<tr>
						       	<td>089898</td>
						       	<td>Jun Santos</td>
						       	<td>Tulips</td>
						       	<td>1</td>
						       	<td>Mabolo St. Caloocan City</td>
						       	<td>0978945902</td>
						      </tr>-->
							</tbody>
						</table>
	...
	function getuser() {
		$.ajax( {
			...
			success: function ( data ) {
				document.getElementById( "orlabel" ).innerHTML = data;
			},
			error: function () {
